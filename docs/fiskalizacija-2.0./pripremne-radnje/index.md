...
!!! warning "Upozorenje sustava"

Zbog Fiskalizacije 2.0 za sve upisane kupce potrebno je napraviti provjeru da li su obveznici primanja eRačuna.
...
!!! note "Napomena o potpunosti podataka"

Ovim ste obavili inicijalno ažuriranje. Ono ne mora biti potpuno jer većina klijenata možda još nije upisana u AMS. Podaci će se automatski provjeravati i kasnije, prilikom izdavanja računa.
...
??? question "Što s inozemnim tvrtkama?"

Ukoliko poslujete s tvrtkama koje su izvan Hrvatske, proces ostaje isti kao i prije.

??? info "Razlika: Javna nabava vs. Standardni eRačun"

Iako se eRačuni šalju na isti način za obje kategorije, postoje razlike u podacima:

!!! success "Zaključak"

Kada ste definirali tipove partnera i njihove statuse eRačuna, završili ste ažuriranje podataka o kupcima/dobavljačima. Aplikacija će ubuduće pri zaključivanju svakog transakcijskog računa automatski provjeravati status kupca u AMS-u.
